import torch
from txt2voice.synthesizer import audio
from txt2voice.synthesizer.hparams import hparams
from txt2voice.synthesizer.models.tacotron import Tacotron
from txt2voice.synthesizer.utils.symbols import symbols
from txt2voice.synthesizer.utils.text import text_to_sequence
from txt2voice.vocoder.display import simple_table
from pathlib import Path
from typing import Union, List
import numpy as np
import librosa
from txt2voice.utils import logmmse
...
class Synthesizer:
    ...
    def load(self):
        """
        Instantiates and loads the model given the model file that was passed in the constructor.
        """
