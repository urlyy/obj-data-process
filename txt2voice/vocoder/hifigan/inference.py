...
from txt2voice.vocoder.hifigan.env import AttrDict
from txt2voice.vocoder.hifigan.meldataset import mel_spectrogram, MAX_WAV_VALUE, load_wav
from txt2voice.vocoder.hifigan.models import Generator
...
def load_model(weights_fpath, verbose=True):
    ...
    with open(os.path.join(os.getcwd(),"txt2voice","vocoder","hifigan","config_16k_.json")) as f:
        data = f.read()
